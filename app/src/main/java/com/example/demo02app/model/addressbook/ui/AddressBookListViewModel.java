...
public class AddressBookListViewModel extends ViewModel {
    private static final String TAG = AddressBookListViewModel.class.getName();
    ...
    public AddressBookListViewModel(Application application, AddressBookRepository addressBookRepository,
    ...
    public static final class Factory extends ViewModelProvider.NewInstanceFactory {
        ...
        public <T extends ViewModel> T create(@NonNull Class<T> modelClass) {
            if (modelClass.isAssignableFrom(AddressBookListViewModel.class)) {
                return (T) new AddressBookListViewModel(application, addressBookRepository, currentUserId);
            } else {
